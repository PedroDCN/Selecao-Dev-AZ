Para rodar a aplicação, utilize Docker, use o comando docker compose up --build que a aplicação frontend será exposta no endereço http://localhost:3000, e a api backend exposta no endereço http://localhost:8080.
